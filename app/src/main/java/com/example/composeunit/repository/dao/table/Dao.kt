package com.example.composeunit.repository.dao.table
...
interface ChinookDao {
    ...
    //1、插入消息到表
    @Insert
    suspend fun insertMessageToChatTable(chatContent: ChatContent)

    //2、查询消息主动更新
    @get:Query("SELECT * FROM chat_content")
    val chatContent: Flow<List<ChatContent>>
